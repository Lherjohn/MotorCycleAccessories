    ...
    <div class="search_main">
        <div class="student_search">
            <form action="" method="POST">
                ...
                <input class="border-primary rounded-2 px-2 py-1 " type="text" name="items" value="" placeholder="Search Accessories">
    ...
    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
        ...
        <table class="table">
            ...
            <tbody align="center">
                ...
                <?php
                $id = $_SESSION['u_id'];
                $getData = $conn->prepare("SELECT COUNT(*) FROM accessories WHERE userID=?");
                $getData->execute([$id]);

                $totalItems = $getData->fetchColumn();
            ...
            <form method="POST" action="process.php">
                <div class="mb-1 row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="item" style="font-size: .7rem;" name="item" value="<?= $data['items'] ?>">
                    </div>
                </div>
                <div class="mb-1 row">
                    <div class="col-3 py-1">
                    ...
                    <div class="mb-1 col">
                        <input type="text" class="form-control" id="price" style="font-size: .7rem;" name="price" value="<?= $data['price'] ?>">
                    </div>
                </div>
                <div class="mb-1 row">
                    <div class="col-3 py-1">
